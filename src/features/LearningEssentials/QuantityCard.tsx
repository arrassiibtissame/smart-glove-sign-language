...
export function QuantityCard() {
  ...
  return (
    <Card
      ...
      onClick={() => navigate("/learning/Quantity")}
    >
      ...
      <CardContent className="flex flex-col items-center gap-3 p-4">
        ...
        <div className="w-full flex items-center justify-center bg-green-600 rounded-xl py-8">
        ...
        <p className="text-gray-500 text-sm text-center">
          Learn the American Sign Language quantity signs
        </p>
