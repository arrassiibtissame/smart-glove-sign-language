...
export function ColorsCard() {
  ...
  return (
    <Card className="border border-gray-200 shadow-sm w-92 rounded-2xl cursor-pointer hover:shadow-md transition-shadow duration-300" onClick={() => navigate("/learning/Colors")}>
      <CardContent className="flex flex-col items-center gap-3 p-4">
        ...
        <p className="text-gray-500 text-sm text-center">{t("cards.colorsDesc")}</p>   
