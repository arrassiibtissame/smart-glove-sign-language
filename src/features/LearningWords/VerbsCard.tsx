  ...
  return (
    ...
    >
      <CardContent className="flex flex-col items-center gap-3 p-4">
        ...
        <p className="text-gray-900 font-bold text-xl">{t("words.verbs")}</p>
        <p className="text-gray-500 text-sm text-center">{t("words.verbsDesc")}</p>
        <span className="bg-blue-50 text-blue-500 text-sm font-medium px-4 py-1 rounded-full">{t("words.verbsBadge")}</span>
      </CardContent>
    </Card>
  );
}